            ...
            <LayoutAccount>
                    ...
                    <div className='col-12'>
                        <div className='card border-0 rounded shadow-sm border-top-success'>
                            <div className='card-header'>
                                <span className='fw-bold'><i className='fa fa-shopping-bag'></i>Upload Product Image</span>
                            </div>
                ...
                <div className='row mt-4'>
                    <div className='col-12'>
                        <div className='card border-0 rounded shadow-sm border-top-success'>
                            <div className='card-header'>
                                <span className='fw-bold'><i className='fa fa-shopping-bag'>Product Image</i></span>
                            </div>
                            <div className='card-body'>
