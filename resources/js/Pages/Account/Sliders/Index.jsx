                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className="fw-bold"><i className="fa fa-images"></i>Image Sliders</span>
                            </div>
                                        ...
                                        <tbody>
                                            {sliders.data.map((slider, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-center"><img src={slider.image} width={'200'} className="rounded-3"/></td>
                                                    <td className="text-center">{slider.link}</td>
                                                    <td className="text-center"><Delete URL={'/account/sliders'} id={slider.id}/></td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
